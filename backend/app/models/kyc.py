...
class KYCApplication(Base):
    ...
    pharmacy_address: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    owner_email: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    owner_phone: Mapped[Optional[str]] = mapped_column(String(64), nullable=True)
    documents_path: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    license_document_name: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    license_document_mime: Mapped[Optional[str]] = mapped_column(String(64), nullable=True)
    license_document_data: Mapped[Optional[bytes]] = mapped_column(LargeBinary, nullable=True)
