                ...
                <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-2 text-sm">
                            <li>
                                <Link className="transition-colors hover:underline" href="/(marketing)/products/pos">
                                    POS
                                </Link>
                            </li>
                            <li>
                                <Link className="transition-colors hover:underline" href="/(marketing)/products/inventory">
                                    Inventory
                                </Link>
                            </li>
                            <li>
                                <Link className="transition-colors hover:underline" href="/(marketing)/products/ai">
                                    AI Assistant
                                </Link>
                            </li>
                            <li>
                                <Link className="transition-colors hover:underline" href="/(marketing)/about">
                                    About
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-2 text-sm">
                            <li>
                                <Link className="transition-colors hover:underline" href="/(marketing)/contact">
                                    Contact
                                </Link>
                            </li>
                            <li>
                                <Link className="transition-colors hover:underline" href="/(marketing)">
                                    Blog
                                </Link>
                            </li>
                            <li>
                                <Link className="transition-colors hover:underline" href="/(auth)/login">
                                    Login
                                </Link>
                            </li>
                            <li>
                                <Link className="transition-colors hover:underline" href="/(auth)/register">
                                    Create Account
                                </Link>
                            </li>
                        </ul>
