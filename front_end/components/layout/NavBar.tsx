          ...
          <NavigationMenuList className="flex gap-1 px-4 py-2">
                ...
                <NavigationMenuLink asChild>
                  <motion.button
                    ...
                    className={[
                      ...
                      isGlass
                        ? "text-emerald-800 hover:bg-emerald-100/70 hover:text-emerald-900"
                        : "text-emerald-700 hover:bg-gradient-to-r hover:from-emerald-50 hover:to-emerald-100 hover:text-emerald-800",
                    ].join(" ")}
                  ...
                  >
                    ...
                    <motion.div
                      className={[
                        ...
                        isGlass
                          ? "bg-emerald-200/30"
                          : "bg-gradient-to-r from-emerald-100/80 to-emerald-200/60",
                      ].join(" ")}
            ...
            <NavigationMenuItem>
              <NavigationMenuLink asChild>
                ...
                >
                  <span className="relative z-10"><Link href="/affiliate">Affiliate</Link></span>
                  <motion.div
                    className={[
                      "absolute inset-0 rounded-lg opacity-0 group-hover/item:opacity-100 transition-opacity",
                      isGlass
