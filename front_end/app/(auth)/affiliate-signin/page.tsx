  ...
  return (
    <>
      ...
      <div className="relative hidden w-0 flex-1 flex-col justify-between overflow-hidden rounded-r-[48px] border border-emerald-100 bg-white/80 p-12 shadow-[0_60px_160px_-90px_rgba(14,116,144,0.55)] backdrop-blur lg:flex">
        ...
        >
          <p>
            “Mesob AI makes login seamless and secure. I can track every business I refer with real-time transparency.”
          </p>
      ...
      <div className="relative flex w-full flex-col justify-center px-4 py-16 sm:px-10 lg:w-[520px] lg:px-12">
        ...
        >
          <div className="mb-8 text-center">
            <h2 className="text-3xl font-bold text-slate-900">Affiliate sign in</h2>
          ...
          <div className="mb-6 flex items-center justify-center gap-3 text-xs uppercase tracking-[0.3em] text-emerald-600">
            <span className={`relative overflow-hidden rounded-full px-3 py-1 ${step === "request" ? "bg-emerald-100 text-emerald-700" : "bg-emerald-50 text-emerald-400"}`}>
              Step 1
            </span>
            <span className={`relative overflow-hidden rounded-full px-3 py-1 ${step === "verify" ? "bg-blue-100 text-blue-700" : "bg-emerald-50 text-emerald-400"}`}>
              Step 2
            </span>
          </div>
          ...
          <p className="mt-8 text-center text-xs text-slate-500">
            ...
            <Link href="/auth?tab=affiliate" className="font-medium text-emerald-600 hover:underline">
              Register here
            </Link>
          </p>
        </motion.div>
