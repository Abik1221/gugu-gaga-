      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Ready to see how Mesob can transform your business operations? 
            Let's schedule a personalized demo tailored to your needs.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <Card className="shadow-lg">
            <CardContent className="p-8">
              <h3 className="text-2xl font-semibold text-gray-900 mb-6">Request Your Demo</h3>
              ...
              {success ? (
                <div className="text-center py-8">
                  ...
                  <h4 className="text-xl font-semibold text-gray-900 mb-2">Demo Request Sent!</h4>
