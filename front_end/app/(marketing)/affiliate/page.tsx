        ...
        >
          ...
          <div className="relative px-8 py-12 md:px-12">
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-3">
              ...
              >
                <Button asChild className="bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-700 hover:to-emerald-800 text-white shadow-lg hover:shadow-2xl transition-all duration-300 px-8 py-3 rounded-lg font-semibold hover:scale-105 transform">
              ...
              >
                ...
                <div className="relative flex items-center gap-2">
                  <motion.button
                    ...
                    className={`relative cursor-pointer z-10 px-8 py-3 rounded-xl text-sm font-medium transition-all duration-200 flex items-center gap-2 ${mode === "signup"
                      ? "text-white"
                  ...
                  <motion.button
                    ...
                    className={`relative cursor-pointer z-10 px-8 py-3 rounded-xl text-sm font-medium transition-all duration-200 flex items-center gap-2 ${mode === "login"
                      ? "text-white"
                      : "text-emerald-700 hover:text-emerald-800"
                      }`}
                    whileHover={{
