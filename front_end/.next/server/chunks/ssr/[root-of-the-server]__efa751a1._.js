...
const AuthAPI = {
    ...
    loginRequestCode: (email, password, expectedRole, tenantId)=>{
        const url = expectedRole ? `/api/v1/auth/login/request-code?expected_role=${encodeURIComponent(expectedRole)}` : "/api/v1/auth/login/request-code";
        return postForm(url, {
            username: email,
            password,
            grant_type: "password"
...
const AdminAPI = {
    ...
    downloadPharmacyLicense: async (applicationId)=>{
        const res = await authFetch(`/api/v1/admin/pharmacies/${applicationId}/license`, {
            method: "GET"
        }, true);
        if (!res.ok) {
            const text = await res.text().catch(()=>"");
...
function setSecureToken(key, token, expiresInHours = 24) {
    if ("TURBOPACK compile-time truthy", 1) return;
    //TURBOPACK unreachable
    ;
...
function AuthProvider({ children }) {
    ...
    const login = async (email, password, tenantId)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AuthAPI"].login(email, password, tenantId);
    ...
    const logout = ()=>{
        setUser(null);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["clearTokens"])();
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$security$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["clearAuthTokens"])();
        // Clear cookies
        if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
        ;
        router.push("/");
...
"[project]/utils/hardcoded-routing.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/components/auth/route-guard.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/navigation.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$hardcoded$2d$routing$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/utils/hardcoded-routing.ts [app-ssr] (ecmascript)");
...
function RouteGuard({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$hardcoded$2d$routing$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["canAccessRoute"])(user, pathname)) {
            const correctRoute = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$hardcoded$2d$routing$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getHardcodedRoute"])(user);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__efa751a1._.js.map