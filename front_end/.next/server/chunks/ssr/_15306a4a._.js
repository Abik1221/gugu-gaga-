...
"[project]/app/(dashboard)/dashboard/admin/users/[id]/roles/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function UserRolesPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        async function load() {
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAuthJSON"])("/auth/me");
                ...
                const [uRes, rRes] = await Promise.all([
                    fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_BASE"]}/admin/users/${encodeURIComponent(userId)}`, {
                        headers: token ? {
                            Authorization: `Bearer ${token}`
                        } : {}
                    }),
                    fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_BASE"]}/admin/roles`, {
                        headers: token ? {
                            Authorization: `Bearer ${token}`
                        } : {}
                    })
    ...
    const assignedIds = new Set((user?.roles || []).map((ur)=>String(ur.role?.id || ur.id)));
    ...
    async function assign(roleId) {
        ...
        try {
            const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAccessToken"])();
            const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_BASE"]}/admin/users/${encodeURIComponent(userId)}/assign-role`, {
                method: "POST",
                headers: {
            ...
            // Refresh user
            const uRes = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_BASE"]}/admin/users/${encodeURIComponent(userId)}`, {
                headers: token ? {
                    Authorization: `Bearer ${token}`
                } : {}
            });
    ...
    async function remove(roleId) {
        ...
        try {
            const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAccessToken"])();
            const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_BASE"]}/admin/users/${encodeURIComponent(userId)}/remove-role`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    ...token ? {
...
//# sourceMappingURL=_15306a4a._.js.map