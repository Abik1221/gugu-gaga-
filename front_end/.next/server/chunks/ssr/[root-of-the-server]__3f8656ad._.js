...
function App({ children }) {
    const [currentPath] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("/dashboard");
    ...
    React.useEffect(()=>{
        async function fetchUser() {
            try {
                const userData = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AuthAPI"].me();
                setUser({
                    name: userData.first_name || 'User',
                    email: userData.email,
                    tenant_id: userData.tenant_id || 'TENANT-001'
                });
            } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3f8656ad._.js.map