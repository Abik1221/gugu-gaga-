...
function AffiliateLoginPage() {
    ...
    async function requestCode(e) {
        ...
        setLoading(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuthAPI"].loginRequestCode(email, password);
            setStep("verify");
...
_s(AffiliateLoginPage, "zncS3Zv5NSLj3xXDaS1HgMDaWvA=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
...
"[project]/components/ui/email-verification-toast.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useEmailVerificationToast() {
    ...
    _s();
    const { show } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"])();
    const showEmailSentNotification = function(email) {
        let purpose = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "register";
        const purposeText = {
            register: "registration",
            login: "login",
            password_reset: "password reset"
    ...
    const showResendCooldown = (secondsLeft)=>{
        show({
            title: "Please Wait",
            description: "You can request a new code in ".concat(secondsLeft, " seconds"),
            variant: "default",
            duration: 3000
        });
    };
...
_s(useEmailVerificationToast, "orYWIciv+IQa+lHWbWxGw7pREs0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"]
    ];
});
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/input.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/toast.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$email$2d$verification$2d$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/email-verification-toast.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/utils/api.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$image$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/image.js [app-client] (ecmascript)");
...
function AffiliateRegisterPage() {
    ...
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const { show } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"])();
    const { showEmailSentNotification } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$email$2d$verification$2d$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEmailVerificationToast"])();
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [error, setError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    async function submitAffiliate(e) {
        ...
        try {
            ...
            setTimeout(()=>window.location.href = "/verify?email=".concat(encodeURIComponent(affEmail), "&purpose=register"), 2000);
        } catch (err) {
...
_s(AffiliateRegisterPage, "ln52ZkviMUBzJViAyUkkx9unvSw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"],
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$email$2d$verification$2d$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEmailVerificationToast"]
    ];
});
...
__turbopack_context__.k.register(_c1, "AuthRouterPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_72acf199._.js.map