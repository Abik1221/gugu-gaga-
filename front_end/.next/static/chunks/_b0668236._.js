...
"[project]/app/(dashboard)/dashboard/affiliate/commissions/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CommissionsListPage() {
    _s();
    const { stats, monthLabel } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$dashboard$292f$dashboard$2f$affiliate$2f$_context$2f$affiliate$2d$dashboard$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAffiliateDashboardContext"])();
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [error, setError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [_me, setMe] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
        ...
        "CommissionsListPage.useEffect": ()=>{
            ...
            async function load() {
                try {
                    ...
                    if (!active) return;
                    setMe(me);
                    const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAccessToken"])();
                    const res = await fetch("".concat(__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE"], "/api/v1/admin/commissions"), {
                        headers: {
                            "Content-Type": "application/json",
                            ...token ? {
                                Authorization: "Bearer ".concat(token)
                            } : {},
                            ...(me === null || me === void 0 ? void 0 : me.tenant_id) ? {
                                "X-Tenant-ID": me.tenant_id
                            } : {}
                        }
                    });
                    if (!res.ok) throw new Error(await res.text().catch({
                        "CommissionsListPage.useEffect.load": ()=>"Failed to load"
                    }["CommissionsListPage.useEffect.load"]));
                    const data = await res.json();
                    if (!active) return;
                    setRows(data);
                } catch (err) {
                    if (!active) return;
                    setError((err === null || err === void 0 ? void 0 : err.message) || "Failed to load commissions");
                } finally{
    ...
    const filtered = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CommissionsListPage.useMemo[filtered]": ()=>{
            const query = q.trim().toLowerCase();
            const now = Date.now();
            let list = rows;
            if (status !== "all") {
                list = list.filter({
                    "CommissionsListPage.useMemo[filtered]": (row)=>row.status.toLowerCase() === status
                }["CommissionsListPage.useMemo[filtered]"]);
            }
            if (range !== "all") {
                ...
                list = list.filter({
                    "CommissionsListPage.useMemo[filtered]": (row)=>new Date(row.earned_at).getTime() >= since
                }["CommissionsListPage.useMemo[filtered]"]);
            }
            if (query) {
                list = list.filter({
                    "CommissionsListPage.useMemo[filtered]": (row)=>row.affiliate.toLowerCase().includes(query)
                }["CommissionsListPage.useMemo[filtered]"]);
            }
            return list;
        }
    ...
    if (error) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "rounded-2xl border border-red-200 bg-red-50/80 p-6 text-sm text-red-600",
            children: error
        }, void 0, false, {
            fileName: "[project]/app/(dashboard)/dashboard/affiliate/commissions/page.tsx",
            lineNumber: 120,
    ...
    const totalCommissions = filtered.reduce((sum, row)=>sum + (row.amount || 0), 0);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "space-y-6",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$dashboard$292f$dashboard$2f$affiliate$2f$_components$2f$cards$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SectionCard"], {
                ...
                description: "You can track performance for ".concat(monthLabel.toLowerCase(), " and comparison ranges."),
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$dashboard$292f$dashboard$2f$affiliate$2f$_components$2f$cards$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StatCard"], {
                            ...
                            description: "Commission earned for the current month"
                        }, void 0, false, {
                            fileName: "[project]/app/(dashboard)/dashboard/affiliate/commissions/page.tsx",
                            lineNumber: 132,
                            columnNumber: 11
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$dashboard$292f$dashboard$2f$affiliate$2f$_components$2f$cards$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StatCard"], {
                            ...
                            description: "Lifetime cleared payouts"
                        }, void 0, false, {
                            fileName: "[project]/app/(dashboard)/dashboard/affiliate/commissions/page.tsx",
                            lineNumber: 142,
                            columnNumber: 11
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$dashboard$292f$dashboard$2f$affiliate$2f$_components$2f$cards$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StatCard"], {
                            ...
                            description: "Across ".concat(filtered.length, " record").concat(filtered.length === 1 ? "" : "s")
                        }, void 0, false, {
                            fileName: "[project]/app/(dashboard)/dashboard/affiliate/commissions/page.tsx",
                            lineNumber: 147,
                            columnNumber: 11
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$dashboard$292f$dashboard$2f$affiliate$2f$_components$2f$cards$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SectionCard"], {
                ...
                description: "Narrow the dataset to focus on recent activity or statuses of interest.",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Input"], {
                                    ...
                                    className: "w-full rounded-xl border-emerald-200 focus:border-emerald-400 focus:ring-emerald-400 lg:w-64"
                                }, void 0, false, {
                                    fileName: "[project]/app/(dashboard)/dashboard/affiliate/commissions/page.tsx",
                                    lineNumber: 158,
                                    columnNumber: 13
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                    ...
                                    className: "h-11 rounded-xl border border-emerald-200 bg-white/90 px-3 text-sm text-emerald-800 focus:border-emerald-400 focus:outline-none",
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                    ...
                                    className: "h-11 rounded-xl border border-emerald-200 bg-white/90 px-3 text-sm text-emerald-800 focus:border-emerald-400 focus:outline-none",
                                    children: rangeOptions.map((option)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                            value: option.value,
                                            children: option.label
                                        }, option.value, false, {
                                            fileName: "[project]/app/(dashboard)/dashboard/affiliate/commissions/page.tsx",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$dashboard$292f$dashboard$2f$affiliate$2f$_components$2f$cards$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SectionCard"], {
                ...
                description: "Page ".concat(pageSafe, " of ").concat(totalPages, ". Displaying ").concat(paged.length, " result").concat(paged.length === 1 ? "" : "s", "."),
                children: [
                    paged.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "rounded-2xl border border-dashed border-emerald-200 bg-emerald-50/60 p-8 text-center text-sm text-emerald-700/80",
                        children: "No commissions match your filters. Adjust search terms or time range to see more activity."
                    }, void 0, false, {
                        fileName: "[project]/app/(dashboard)/dashboard/affiliate/commissions/page.tsx",
                        lineNumber: 224,
                        columnNumber: 11
                    }, this) : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "overflow-hidden rounded-2xl border border-emerald-100/70",
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                            className: "min-w-full divide-y divide-emerald-100/70 text-sm text-emerald-900",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("thead", {
                                    className: "bg-emerald-50/70 text-xs uppercase tracking-wide text-emerald-600",
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                    className: "divide-y divide-emerald-50/80 bg-white",
                                    children: paged.map((row)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    className: "px-4 py-3 font-medium text-emerald-900",
                                                    children: row.affiliate
                                                }, void 0, false, {
                                                    fileName: "[project]/app/(dashboard)/dashboard/affiliate/commissions/page.tsx",
                                                    lineNumber: 242,
                                                    columnNumber: 21
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    className: "px-4 py-3 text-emerald-900",
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    className: "px-4 py-3 text-emerald-700",
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    className: "px-4 py-3 text-xs text-emerald-600",
                                                    children: new Date(row.earned_at).toLocaleDateString()
                                                }, void 0, false, {
                                                    fileName: "[project]/app/(dashboard)/dashboard/affiliate/commissions/page.tsx",
                                                    lineNumber: 248,
                                                    columnNumber: 21
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "mt-4 flex flex-wrap items-center justify-between gap-3 text-sm text-emerald-700/80",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    "Page ",
...
_s(CommissionsListPage, "ewY4BIZSp0qu/LTRzuCvz4GqmN8=", false, function() {
    return [
...
_c = CommissionsListPage;
function StatusBadge(param) {
    let { status } = param;
    const tone = status === null || status === void 0 ? void 0 : status.toLowerCase();
    const styles = tone === "approved" ? "bg-emerald-50 text-emerald-700" : tone === "paid" ? "bg-blue-50 text-blue-600" : "bg-amber-50 text-amber-700";
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
        className: "inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold ".concat(styles),
...
var _c, _c1;
__turbopack_context__.k.register(_c, "CommissionsListPage");
...
//# sourceMappingURL=_b0668236._.js.map