...
function POSPage() {
    ...
    function extractReceiptId(tx) {
        ...
        async function serverGetCart(sid) {
            const res = await fetch("".concat(__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE"], "/pos/sessions/").concat(sid, "/cart"), {
                headers: authHeaders()
            });
            if (!res.ok) return;
        ...
        async function serverRemoveFromCart(sid, itemId) {
            const res = await fetch("".concat(__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE"], "/pos/sessions/").concat(sid, "/cart/").concat(encodeURIComponent(itemId)), {
                method: "DELETE",
                headers: authHeaders()
            });
            if (!res.ok) return;
        ...
        async function clearCart() {
            ...
            try {
                if (sessionId) {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["postAuthJSON"])("/pos/sessions/".concat(sessionId, "/clear"), {});
                }
            } catch (e) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
            "POSPage.extractReceiptId.useEffect": ()=>{
                let active = true;
                async function load() {
                    try {
                        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAuthJSON"])("/inventory/items");
                        if (!active) return;
                        setItems(data);
                    } catch (e) {
                        if (!active) return;
                ...
                async function loadBranches() {
                    try {
                        const res = await fetch("".concat(__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE"], "/admin/branches"), {
                            headers: {
                ...
                ({
                    "POSPage.extractReceiptId.useEffect": async ()=>{
                        const sid = ("TURBOPACK compile-time truthy", 1) ? localStorage.getItem("pos_session_id") : "TURBOPACK unreachable";
        ...
        const filtered = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
            "POSPage.extractReceiptId.useMemo[filtered]": ()=>{
                const q = query.trim().toLowerCase();
                if (!q) return items;
                return items.filter({
                    "POSPage.extractReceiptId.useMemo[filtered]": (it)=>it.name.toLowerCase().includes(q) || it.sku.toLowerCase().includes(q)
                }["POSPage.extractReceiptId.useMemo[filtered]"]);
            }
        }["POSPage.extractReceiptId.useMemo[filtered]"], [
            items,
        ...
        const subtotal = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
            "POSPage.extractReceiptId.useMemo[subtotal]": ()=>cart.reduce({
                    "POSPage.extractReceiptId.useMemo[subtotal]": (s, l)=>s + l.price * l.qty
                }["POSPage.extractReceiptId.useMemo[subtotal]"], 0)
        }["POSPage.extractReceiptId.useMemo[subtotal]"], [
            cart
        ]);
        ...
        async function ensureSession() {
            ...
            try {
                ...
                const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["postAuthJSON"])("/pos/sessions", payload);
        ...
        async function checkout() {
            ...
            try {
                const tx = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["postAuthJSON"])("/pos/sessions/".concat(sid, "/checkout"), payload);
                show({
                    variant: "success",
    ...
    _s1(extractReceiptId, "MXoKf+1OPfJHFquSGQUA9RZYyhc=");
}
_s(POSPage, "ndmgHADGJhnDBwOCwwJABnyPDVc=", false, function() {
    return [
