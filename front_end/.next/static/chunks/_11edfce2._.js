...
"[project]/app/(dashboard)/dashboard/supplier/chat/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const suggestedQuestions = [
    ...
    "Show me inventory levels for critical items",
    "Analyze my customer satisfaction trends",
...
function SupplierAIChat() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SupplierAIChat.useEffect": ()=>{
            ...
            const welcomeMessage = {
                id: "welcome",
                content: "Hello! I'm your AI business assistant. I can help you analyze your supplier performance, track orders, manage inventory, and provide business insights. What would you like to know?",
                sender: "ai",
                timestamp: new Date()
            };
            setMessages([
    ...
    const sendMessage = async (content)=>{
        ...
        try {
            ...
            show({
                ...
                description: (err === null || err === void 0 ? void 0 : err.message) || "Unable to get AI response"
            });
        } finally{
            setIsLoading(false);
        }
    ...
    const generateAIResponse = (userMessage)=>{
        ...
        if (lowerMessage.includes("top") && lowerMessage.includes("product")) {
            return "📊 **Top Performing Products This Month:**\n\n1. **Paracetamol 500mg** - 2,847 units sold ($28,470 revenue)\n2. **Ibuprofen 200mg** - 1,923 units sold ($19,230 revenue)\n3. **Aspirin 100mg** - 1,654 units sold ($16,540 revenue)\n4. **Amoxicillin 250mg** - 1,432 units sold ($21,480 revenue)\n5. **Omeprazole 20mg** - 1,287 units sold ($25,740 revenue)\n\n**Key Insights:**\n• Pain relief medications show highest volume\n• Antibiotics have better profit margins\n• Consider increasing stock for top 3 products";
        }
        if (lowerMessage.includes("inventory") || lowerMessage.includes("stock")) {
            return "📦 **Current Inventory Status:**\n\n**Critical Stock Levels:**\n• Ibuprofen 200mg: 45 units (Reorder: 100)\n• Aspirin 100mg: 23 units (Reorder: 50)\n• Vitamin D3: 12 units (Reorder: 75)\n\n**Well Stocked:**\n• Paracetamol 500mg: 450 units\n• Amoxicillin 250mg: 320 units\n• Omeprazole 20mg: 280 units\n\n**Recommendations:**\n• Place urgent orders for critical items\n• Consider bulk purchasing for fast-moving products\n• Review reorder levels for seasonal items";
        }
        if (lowerMessage.includes("customer") && lowerMessage.includes("satisfaction")) {
            return "⭐ **Customer Satisfaction Analysis:**\n\n**Overall Rating:** 94.5% (Excellent)\n\n**Breakdown by Category:**\n• Product Quality: 96.2%\n• Delivery Time: 93.8%\n• Customer Service: 95.1%\n• Pricing: 92.4%\n\n**Recent Feedback Highlights:**\n✅ \"Excellent product quality and fast delivery\"\n✅ \"Reliable supplier with consistent stock\"\n⚠️ \"Pricing could be more competitive\"\n\n**Action Items:**\n• Maintain current quality standards\n• Review pricing strategy for key products\n• Continue focus on delivery excellence";
        }
        if (lowerMessage.includes("pending") && lowerMessage.includes("order")) {
            return "📋 **Pending Orders Summary:**\n\n**Total Pending:** 23 orders ($67,450 value)\n\n**By Priority:**\n🔴 **Urgent (5 orders):**\n• MediCorp - $15,750 (Due: Today)\n• PharmaCare - $8,920 (Due: Tomorrow)\n• HealthPlus - $6,340 (Due: Tomorrow)\n\n🟡 **Standard (18 orders):**\n• Various customers - $36,440 total\n• Due dates: Next 3-7 days\n\n**Recommended Actions:**\n1. Process urgent orders immediately\n2. Prepare shipments for tomorrow's deliveries\n3. Contact customers for any potential delays";
        }
        if (lowerMessage.includes("report") || lowerMessage.includes("performance")) {
            return "📈 **Sales Performance Report - Current Month:**\n\n**Revenue:** $125,750 (+15% vs last month)\n**Orders:** 1,847 (+8% vs last month)\n**Average Order Value:** $68.12 (+6% vs last month)\n\n**Top Categories:**\n1. Pain Relief: $45,230 (36%)\n2. Antibiotics: $32,150 (26%)\n3. Vitamins: $28,940 (23%)\n4. Cardiovascular: $19,430 (15%)\n\n**Performance Metrics:**\n• Order Fulfillment Rate: 98.2%\n• Customer Retention: 89.4%\n• Inventory Turnover: 8.4x\n• Profit Margin: 24.8%\n\n**Growth Opportunities:**\n• Expand vitamin product line\n• Target new pharmacy chains\n• Optimize pricing for antibiotics";
        }
        return "I understand you're asking about your supplier business. I can help you with:\n\n🔍 **Analytics & Reports**\n• Sales performance analysis\n• Product performance metrics\n• Customer satisfaction insights\n\n📦 **Inventory Management**\n• Stock level monitoring\n• Reorder recommendations\n• Demand forecasting\n\n👥 **Customer Management**\n• Order status tracking\n• Customer performance analysis\n• Relationship insights\n\n💰 **Financial Insights**\n• Revenue analysis\n• Profit margin optimization\n• Payment tracking\n\nPlease ask me something specific, or try one of the suggested questions below!";
    };
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$sparkles$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Sparkles$3e$__["Sparkles"], {
                                ...
                                fileName: "[project]/app/(dashboard)/dashboard/supplier/chat/page.tsx",
                                lineNumber: 127,
                                columnNumber: 11
                            }, this),
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "Get intelligent insights about your supplier business"
                    }, void 0, false, {
                        fileName: "[project]/app/(dashboard)/dashboard/supplier/chat/page.tsx",
                        lineNumber: 130,
                        columnNumber: 9
                                            ...
                                            children: [
                                                messages.map((message)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: "max-w-[80%] rounded-lg p-3 ".concat(message.sender === "user" ? "bg-blue-600 text-white" : "bg-gray-100 text-gray-900"),
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(SupplierAIChat, "HB4rgyEtW9iAL21xbrwJ9rXuQhY=", false, function() {
    return [
...
_c = SupplierAIChat;
var _c;
__turbopack_context__.k.register(_c, "SupplierAIChat");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_11edfce2._.js.map