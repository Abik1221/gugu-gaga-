...
function OwnerKYCPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const response = await fetch("http://localhost:8000/api/v1/owner/kyc/status?tenant_id=".concat(tenantId), {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
...
_s1(OwnerKYCPage, "1S6hXe2Q2EyvVZmkLiIXZKQtZCM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"]
    ];
...
//# sourceMappingURL=_6483b858._.js.map