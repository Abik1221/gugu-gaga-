...
function ForgotPasswordPage() {
    ...
    const handleRequestCode = async (e)=>{
        ...
        setLoading(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["postJSON"])("/api/v1/auth/password/reset/request", {
                email
            });
            setErrorDialog({
                isOpen: true,
                title: "Code Sent Successfully!",
                message: "We've sent a 6-digit verification code to ".concat(email, ". Please check your inbox and enter the code below."),
                type: "success"
            });
            setStep("code");
        } catch (error) {
            ...
            if (message.includes("No account")) {
                setErrorDialog({
                    ...
                    message: "We couldn't find an account with the email \"".concat(email, '". Please check your email address and try again.'),
                    type: "error"
                });
            } else {
                setErrorDialog({
    ...
    const handleResetPassword = async (e)=>{
        ...
        setLoading(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["postJSON"])("/api/v1/auth/password/reset/confirm", {
                email,
                code,
            ...
            if (message.includes("No account")) {
                setErrorDialog({
                    isOpen: true,
                    title: "Account Not Found",
                    message: "We couldn't find an account with the email \"".concat(email, '". Please check your email address.'),
                    type: "error"
                });
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                            children: step === "email" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
...
_s(ForgotPasswordPage, "QZJpt7k5Zbnz46rFHTdvJMC0iDc=", false, function() {
    return [
...
//# sourceMappingURL=_a9114f21._.js.map