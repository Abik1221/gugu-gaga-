...
const API_BASE = ("TURBOPACK compile-time value", "http://127.0.0.1:8000/api/v1") || "http://13.61.24.25:8000/api/v1";
...
const AuthAPI = {
    ...
    registerVerify: async (email, code)=>{
        console.log('🔍 AuthAPI.registerVerify called with:', {
            email,
            code
        });
        // Clean inputs
        ...
        try {
            const result = await postForm("/api/v1/auth/register/verify", {
                email: cleanEmail,
                code: cleanCode
            });
            ...
            var _err_message, _err_body;
            console.error('❌ registerVerify failed:', err);
            // Handle network errors
            if ((err === null || err === void 0 ? void 0 : err.name) === 'NetworkError' || (err === null || err === void 0 ? void 0 : err.name) === 'TypeError' && (err === null || err === void 0 ? void 0 : (_err_message = err.message) === null || _err_message === void 0 ? void 0 : _err_message.includes('fetch'))) {
                throw new Error('Network error - please check your connection and try again');
            }
            // Handle specific HTTP errors with user-friendly messages
            if ((err === null || err === void 0 ? void 0 : err.status) === 404) {
                throw new Error('No account found with this email address');
            } else if ((err === null || err === void 0 ? void 0 : err.status) === 400) {
                var _err_body1;
                // Check if the error message contains more specific info
                const errorMsg = (err === null || err === void 0 ? void 0 : err.message) || (err === null || err === void 0 ? void 0 : (_err_body1 = err.body) === null || _err_body1 === void 0 ? void 0 : _err_body1.detail) || 'Invalid or expired verification code';
                ...
                try {
                    const result = await postJSON("/api/v1/auth/register/verify", {
                        email: cleanEmail,
                        code: cleanCode
                    });
                    ...
                    if ((err2 === null || err2 === void 0 ? void 0 : err2.status) === 404) {
                        throw new Error('No account found with this email address');
                    } else if ((err2 === null || err2 === void 0 ? void 0 : err2.status) === 400) {
                        var _err2_body;
                        const errorMsg = (err2 === null || err2 === void 0 ? void 0 : err2.message) || (err2 === null || err2 === void 0 ? void 0 : (_err2_body = err2.body) === null || _err2_body === void 0 ? void 0 : _err2_body.detail) || 'Invalid or expired verification code';
                        if (errorMsg.includes('Invalid or expired')) {
                            throw new Error('Invalid or expired verification code. Please check your email or request a new code.');
                        }
                        throw new Error(errorMsg);
            ...
            const errorMessage = (err === null || err === void 0 ? void 0 : err.message) || (err === null || err === void 0 ? void 0 : (_err_body = err.body) === null || _err_body === void 0 ? void 0 : _err_body.detail) || 'Verification failed';
    ...
    loginRequestCode: (email, password, expectedRole, tenantId)=>{
        const url = expectedRole ? "/api/v1/auth/login/request-code?expected_role=".concat(encodeURIComponent(expectedRole)) : "/api/v1/auth/login/request-code";
        return postForm(url, {
            username: email,
            password,
            grant_type: "password"
...
const AdminAPI = {
    ...
    downloadPharmacyLicense: async (applicationId)=>{
        const res = await authFetch("/api/v1/admin/pharmacies/".concat(applicationId, "/license"), {
            method: "GET"
        }, true);
        if (!res.ok) {
            const text = await res.text().catch(()=>"");
...
function setSecureToken(key, token) {
    let expiresInHours = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 24;
    if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
    ;
 ...
 */ class RateLimiter {
    ...
    constructor(){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "requests", new Map());
    }
}
...
function generateSecureToken() {
    ...
    if ("object" !== 'undefined' && window.crypto && window.crypto.getRandomValues) {
...
function AuthProvider(param) {
    ...
    const login = async (email, password, tenantId)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuthAPI"].login(email, password, tenantId);
        // Store tokens in cookies for middleware access
        if ("object" !== "undefined" && response.access_token) {
            const isProduction = ("TURBOPACK compile-time value", "development") === 'production';
            const cookieOptions = "path=/; max-age=".concat(20160 * 60, "; ").concat(("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : '', "samesite=strict");
            document.cookie = "access_token=".concat(response.access_token, "; ").concat(cookieOptions);
            if (response.refresh_token) {
                document.cookie = "refresh_token=".concat(response.refresh_token, "; path=/; max-age=").concat(14 * 24 * 60 * 60, "; ").concat(("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : '', "samesite=strict");
            }
        }
        await refreshUser();
    };
    const logout = ()=>{
        setUser(null);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clearTokens"])();
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$security$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clearAuthTokens"])();
        // Clear cookies
        if ("TURBOPACK compile-time truthy", 1) {
...
"[project]/utils/hardcoded-routing.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getHardcodedRoute(user) {
    if (!user) return '/';
...
function canAccessRoute(user, pathname) {
    ...
    switch(user.role){
        ...
        case 'pharmacy_owner':
            ...
            if ((user.subscription_status === 'pending_verification' || user.subscription_blocked) && pathname.startsWith('/dashboard') && !pathname.includes('/payment')) {
                return false;
            }
...
"[project]/components/auth/route-guard.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/navigation.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$hardcoded$2d$routing$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/utils/hardcoded-routing.ts [app-client] (ecmascript)");
...
function RouteGuard(param) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RouteGuard.useEffect": ()=>{
            ...
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$hardcoded$2d$routing$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["canAccessRoute"])(user, pathname)) {
                const correctRoute = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$hardcoded$2d$routing$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getHardcodedRoute"])(user);
    ...
    if (loading || !isAuthorized) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                fileName: "[project]/components/auth/route-guard.tsx",
                lineNumber: 48,
                columnNumber: 9
            }, this)
        }, void 0, false, {
...
_s(RouteGuard, "NIvqqJNyktXA3dB4X/Cj/DavUQ0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
...
//# sourceMappingURL=_6c1c9b88._.js.map