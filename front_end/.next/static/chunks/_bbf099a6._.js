...
function StaffListPage() {
    ...
    const loadStaff = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StaffListPage.useCallback[loadStaff]": async (tid, options)=>{
            ...
            try {
                ...
                const message = (err === null || err === void 0 ? void 0 : err.message) || "Unable to load staff";
                setError(message);
                show({
                    variant: "destructive",
    ...
    }["StaffListPage.useCallback[loadStaff]"], [
        show
    ]);
        ...
        "StaffListPage.useEffect": ()=>{
            ...
            async function bootstrap() {
                ...
                try {
                    ...
                    if (!active) return;
                    setProfile(me);
                    const tid = (me === null || me === void 0 ? void 0 : me.tenant_id) || null;
                    setTenantId(tid);
                    if (tid) {
                        await loadStaff(tid);
                    } else {
                    ...
                    if (!active) return;
                    setError((err === null || err === void 0 ? void 0 : err.message) || "Unable to load user profile");
                } finally{
    ...
    const filteredStaff = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "StaffListPage.useMemo[filteredStaff]": ()=>{
            const query = search.trim().toLowerCase();
            return staff.filter({
                "StaffListPage.useMemo[filteredStaff]": (member)=>{
                    var _member_email, _member_phone, _member_role, _member_assigned_branch_name;
                    ...
                    return ((_member_email = member.email) === null || _member_email === void 0 ? void 0 : _member_email.toLowerCase().includes(query)) || ((_member_phone = member.phone) === null || _member_phone === void 0 ? void 0 : _member_phone.toLowerCase().includes(query)) || ((_member_role = member.role) === null || _member_role === void 0 ? void 0 : _member_role.toLowerCase().includes(query)) || ((_member_assigned_branch_name = member.assigned_branch_name) === null || _member_assigned_branch_name === void 0 ? void 0 : _member_assigned_branch_name.toLowerCase().includes(query));
                }
            }["StaffListPage.useMemo[filteredStaff]"]).sort({
                "StaffListPage.useMemo[filteredStaff]": (a, b)=>a.email.localeCompare(b.email)
            }["StaffListPage.useMemo[filteredStaff]"]);
        }
    }["StaffListPage.useMemo[filteredStaff]"], [
        staff,
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "StaffListPage.useMemo[stats]": ()=>{
            const activeCount = staff.filter({
                "StaffListPage.useMemo[stats]": (m)=>m.is_active !== false
            }["StaffListPage.useMemo[stats]"]).length;
    ...
    const handleToggleActive = async (member, nextActive)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StaffAPI"].update(tenantId, member.id, {
    ...
    const handleRemove = async (member)=>{
        if (!tenantId) return;
        const confirmed = window.confirm("Remove ".concat(member.email, "? This cannot be undone."));
        if (!confirmed) return;
        setMutatingId(member.id);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StaffAPI"].remove(tenantId, member.id);
            show({
                variant: "success",
                title: "Staff removed",
                description: member.email
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                            ...
                            children: isBusy ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$skeleton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Skeleton"], {
                                ...
                                lineNumber: 250,
                                columnNumber: 15
                            }, this) : filteredStaff.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: filteredStaff.map((member)=>{
                                                ...
                                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                            className: "px-3 py-3 text-emerald-100/70",
                                                            children: member.assigned_branch_name || (member.assigned_branch_id ? "#".concat(member.assigned_branch_id) : "—")
                                                        }, void 0, false, {
                                                            fileName: "[project]/app/(dashboard)/dashboard/owner/staff/page.tsx",
                                                            lineNumber: 276,
                                                            columnNumber: 27
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(InviteStaffSheet, {
                open: inviteOpen,
...
_s(StaffListPage, "IzsqV/n4vHi44vlWhLkBOqBroJ0=", false, function() {
    return [
...
_c = StaffListPage;
function InviteStaffSheet(param) {
    let { open, onOpenChange, tenantId, onInvited } = param;
    _s1();
    const { show } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"])();
    const [email, setEmail] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [password, setPassword] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [phone, setPhone] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [role] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("staff");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "InviteStaffSheet.useEffect": ()=>{
            if (!open || !tenantId) return;
            let active = true;
            __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BranchAPI"].list(tenantId, {
                page_size: 100
            }).then({
                "InviteStaffSheet.useEffect": (res)=>{
                    if (!active) return;
                    const items = Array.isArray(res === null || res === void 0 ? void 0 : res.items) ? res.items.map({
                        "InviteStaffSheet.useEffect": (it)=>({
                                id: Number(it.id),
                                name: String(it.name)
                            })
                    }["InviteStaffSheet.useEffect"]) : Array.isArray(res) ? res.map({
                        "InviteStaffSheet.useEffect": (it)=>({
                                id: Number(it.id),
                                name: String(it.name)
                            })
            ...
            }["InviteStaffSheet.useEffect"]).catch({
                "InviteStaffSheet.useEffect": ()=>{
                    if (!active) return;
                    setBranches([]);
                }
    ...
    const handleSubmit = async (event)=>{
        ...
        setSubmitting(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StaffAPI"].createCashier(tenantId, {
                email,
                password,
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                branches.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "text-xs text-emerald-100/60",
...
_s1(InviteStaffSheet, "WUaE/BBzTBKInN7HrkfCUvJBN2c=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"]
    ];
});
_c1 = InviteStaffSheet;
var _c, _c1;
__turbopack_context__.k.register(_c, "StaffListPage");
__turbopack_context__.k.register(_c1, "InviteStaffSheet");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_bbf099a6._.js.map