...
function PharmacySignInPage() {
    ...
    async function handleSubmit(ev) {
        ...
        try {
            ...
            setErrors({
                form: err.message || "Failed to sign in. Check credentials and try again."
            });
        } finally{
            setLoading(false);
        }
    ...
    async function handleVerifyOtp(ev) {
        ...
        try {
            ...
            setErrors({
                form: err.message || "Invalid verification code"
            });
        } finally{
            setLoading(false);
        }
...
_s(PharmacySignInPage, "VGnby7a/ztxGeKNWvMqgkjshvmA=");
...
//# sourceMappingURL=app_%28auth%29_owner-signin_page_tsx_8c809ef1._.js.map