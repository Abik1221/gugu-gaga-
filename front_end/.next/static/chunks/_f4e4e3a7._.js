        ...
        "POSPage.useEffect": ()=>{
            ...
            async function load() {
                try {
                    ...
                    const list = Array.isArray(data === null || data === void 0 ? void 0 : data.items) ? data.items.map({
                        "POSPage.useEffect.load": (raw)=>{
                            var _raw_id, _raw_medicine_name, _raw_sku, _raw_sell_price, _raw_quantity;
                            return {
                                id: String((_raw_id = raw.id) !== null && _raw_id !== void 0 ? _raw_id : ""),
                                name: String((_raw_medicine_name = raw.medicine_name) !== null && _raw_medicine_name !== void 0 ? _raw_medicine_name : ""),
                                sku: String((_raw_sku = raw.sku) !== null && _raw_sku !== void 0 ? _raw_sku : ""),
                                sale_price: Number((_raw_sell_price = raw.sell_price) !== null && _raw_sell_price !== void 0 ? _raw_sell_price : 0),
                                stock_qty: Number((_raw_quantity = raw.quantity) !== null && _raw_quantity !== void 0 ? _raw_quantity : 0)
                            };
                        }
                    }["POSPage.useEffect.load"]) : [];
                    if (!active) return;
                    setItems(list);
                } catch (e) {
                    if (!active) return;
...
//# sourceMappingURL=_f4e4e3a7._.js.map