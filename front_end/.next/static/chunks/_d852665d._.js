...
"[project]/app/(dashboard)/dashboard/owner/inventory/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function InventoryPage() {
    ...
    const [branchFilter, setBranchFilter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [lowStockOnly, setLowStockOnly] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [expiringInDays, setExpiringInDays] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(undefined);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "InventoryPage.useEffect": ()=>{
            const handle = window.setTimeout({
                "InventoryPage.useEffect.handle": ()=>setDebouncedSearch(search.trim())
            }["InventoryPage.useEffect.handle"], 300);
            return ({
                "InventoryPage.useEffect": ()=>window.clearTimeout(handle)
            })["InventoryPage.useEffect"];
        }
    }["InventoryPage.useEffect"], [
        search
        ...
        "InventoryPage.useEffect": ()=>{
            ...
            async function loadProfile() {
                try {
                    ...
                    if (!active) return;
                    setMe(profile);
                    setTenantId((profile === null || profile === void 0 ? void 0 : profile.tenant_id) || null);
                } catch (err) {
                    if (!active) return;
                    setError((err === null || err === void 0 ? void 0 : err.message) || "Unable to load inventory");
                } finally{
    ...
    const loadInventory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "InventoryPage.useCallback[loadInventory]": async (tid)=>{
            setFetching(true);
            setError(null);
            try {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InventoryAPI"].list(tid, {
                ...
                setError((err === null || err === void 0 ? void 0 : err.message) || "Failed to load inventory");
            } finally{
                setFetching(false);
            }
        }
    ...
    const branchOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "InventoryPage.useMemo[branchOptions]": ()=>{
            const set = new Set();
            items.forEach({
                "InventoryPage.useMemo[branchOptions]": (item)=>{
                    if (item.branch) set.add(item.branch);
                }
            }["InventoryPage.useMemo[branchOptions]"]);
            return Array.from(set).sort({
                "InventoryPage.useMemo[branchOptions]": (a, b)=>a.localeCompare(b)
            }["InventoryPage.useMemo[branchOptions]"]);
        }
    }["InventoryPage.useMemo[branchOptions]"], [
        items
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "InventoryPage.useMemo[stats]": ()=>{
            ...
            const totalUnits = items.reduce({
                "InventoryPage.useMemo[stats].totalUnits": (acc, item)=>acc + (item.quantity || 0)
            }["InventoryPage.useMemo[stats].totalUnits"], 0);
            const lowStockLots = items.filter({
                "InventoryPage.useMemo[stats]": (item)=>{
                    var _item_reorder_level;
                    return (item.quantity || 0) <= ((_item_reorder_level = item.reorder_level) !== null && _item_reorder_level !== void 0 ? _item_reorder_level : 0);
                }
    ...
    const refreshInventory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "InventoryPage.useCallback[refreshInventory]": (options)=>{
            if (!tenantId) return;
            if ((options === null || options === void 0 ? void 0 : options.resetPage) && page !== 1) {
                setPage(1);
                return;
            }
            loadInventory(tenantId);
        }
    }["InventoryPage.useCallback[refreshInventory]"], [
        tenantId,
        page,
        loadInventory
    ]);
        ...
        children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                ...
                                children: "Inventory workspace"
                            }, void 0, false, {
                                fileName: "[project]/app/(dashboard)/dashboard/owner/inventory/page.tsx",
                                lineNumber: 203,
                                columnNumber: 11
                            }, this),
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-sm text-gray-500",
                                children: "Track medicine lots, adjust reorder levels, and record new stock arrivals."
                            }, void 0, false, {
                                fileName: "[project]/app/(dashboard)/dashboard/owner/inventory/page.tsx",
                                lineNumber: 204,
                                columnNumber: 11
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                ...
                children: [
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardTitle"], {
                                    ...
                                    children: "Lots on file"
                                }, void 0, false, {
                                    fileName: "[project]/app/(dashboard)/dashboard/owner/inventory/page.tsx",
                                    lineNumber: 232,
                                    columnNumber: 13
                                }, this),
                                initializing ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$skeleton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Skeleton"], {
                                    className: "h-7 w-16"
                                }, void 0, false, {
                                    fileName: "[project]/app/(dashboard)/dashboard/owner/inventory/page.tsx",
                                    lineNumber: 236,
                                    ...
                                    children: numberFormatter.format(stats.totalLots)
                                }, void 0, false, {
                                    fileName: "[project]/app/(dashboard)/dashboard/owner/inventory/page.tsx",
                                    lineNumber: 238,
                                    columnNumber: 15
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                            ...
                            children: [
                                ...
                                initializing ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$skeleton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Skeleton"], {
                                    ...
                                    className: "text-xl font-semibold text-gray-900",
                                    children: numberFormatter.format(stats.totalUnits)
                                }, void 0, false, {
                                    fileName: "[project]/app/(dashboard)/dashboard/owner/inventory/page.tsx",
                                    lineNumber: 252,
                                    columnNumber: 15
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                            ...
                            children: [
                                ...
                                initializing ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$skeleton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Skeleton"], {
                                    ...
                                    children: numberFormatter.format(stats.lowStockLots)
                                }, void 0, false, {
                                    fileName: "[project]/app/(dashboard)/dashboard/owner/inventory/page.tsx",
                                    lineNumber: 266,
                                    columnNumber: 15
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                        className: "border border-sky-200 bg-sky-50/60 shadow-sm",
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                            className: "space-y-1",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardTitle"], {
                                    className: "text-xs uppercase tracking-wide text-sky-700",
                                ...
                                initializing ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$skeleton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Skeleton"], {
                                    ...
                                    children: numberFormatter.format(stats.expiringSoon)
                                }, void 0, false, {
                                    fileName: "[project]/app/(dashboard)/dashboard/owner/inventory/page.tsx",
                                    lineNumber: 280,
                                    columnNumber: 15
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                            value: expiringInDays !== null && expiringInDays !== void 0 ? expiringInDays : "",
                                            onChange: (event)=>{
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                            ...
                            children: [
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                                ...
                                                children: [
                                                    items.map((item)=>{
                                                        var _item_reorder_level;
                                                        const lowStock = (item.quantity || 0) <= ((_item_reorder_level = item.reorder_level) !== null && _item_reorder_level !== void 0 ? _item_reorder_level : 0);
                                                        const packsDisplay = item.pack_size ? "".concat(Math.floor((item.quantity || 0) / item.pack_size), " packs") : "—";
                                                        const singlesDisplay = item.pack_size ? "".concat((item.quantity || 0) % item.pack_size, " singles") : "".concat(item.quantity || 0, " units");
                                                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                            className: lowStock ? "bg-red-50/60" : undefined,
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                    className: "px-3 py-2 text-gray-700",
                                                                    children: numberFormatter.format(item.reorder_level || 0)
                                                                }, void 0, false, {
                                                                    fileName: "[project]/app/(dashboard)/dashboard/owner/inventory/page.tsx",
                                                                    lineNumber: 405,
                                                                    columnNumber: 25
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                    className: "px-3 py-2 text-gray-700",
                                                                    children: item.sell_price != null ? formatCurrency(item.sell_price) : "—"
                                                                }, void 0, false, {
                                                                    fileName: "[project]/app/(dashboard)/dashboard/owner/inventory/page.tsx",
                                                                    lineNumber: 407,
                                                                    columnNumber: 25
                                                    ...
                                                    items.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                            ...
                                                            colSpan: 7,
                                                            children: fetching ? "Loading inventory..." : "No inventory lots match your filters."
                                                        }, void 0, false, {
                                                            fileName: "[project]/app/(dashboard)/dashboard/owner/inventory/page.tsx",
                                                            lineNumber: 424,
                                                            columnNumber: 23
                                ...
                                fetching && items.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$skeleton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Skeleton"], {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AddStockSheet, {
                open: createOpen,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(EditLotSheet, {
                item: editingItem,
                tenantId: tenantId !== null && tenantId !== void 0 ? tenantId : undefined,
...
_s(InventoryPage, "UrUzDI5wnVAxkxWMjtbFFwPTS3w=", false, function() {
    return [
...
_c = InventoryPage;
function AddStockSheet(param) {
    let { open, onOpenChange, tenantId, onCreated } = param;
    _s1();
    const { show } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"])();
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [medicineOptions, setMedicineOptions] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [medicinesLoading, setMedicinesLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [medicineId, setMedicineId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const [packSize, setPackSize] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("1");
    const [packsCount, setPacksCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("0");
    const [singlesCount, setSinglesCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("0");
    ...
    const [reorderLevel, setReorderLevel] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("0");
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AddStockSheet.useEffect": ()=>{
            if (!open || !tenantId) return;
            setMedicinesLoading(true);
            __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MedicinesAPI"].list(tenantId, {
                pageSize: 200
            }).then({
                "AddStockSheet.useEffect": (response)=>{
                    setMedicineOptions(response.items);
                }
            }["AddStockSheet.useEffect"]).catch({
                "AddStockSheet.useEffect": (err)=>{
                    show({
                        variant: "destructive",
                        title: "Unable to load medicines",
                        description: (err === null || err === void 0 ? void 0 : err.message) || "Please try again shortly."
                    });
                }
            }["AddStockSheet.useEffect"]).finally({
                "AddStockSheet.useEffect": ()=>setMedicinesLoading(false)
            }["AddStockSheet.useEffect"]);
        }
    }["AddStockSheet.useEffect"], [
        open,
    ...
    const handleSubmit = async (event)=>{
        ...
        if (!parsedMedicineId) {
            show({
                ...
                description: "Choose a medicine to add stock for."
            });
            return;
        }
        ...
        if (parsedPacks === 0 && parsedSingles === 0) {
            show({
                ...
                description: "Enter packs or single units to record."
            });
            return;
        }
        setLoading(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InventoryAPI"].create(tenantId, {
            ...
            show({
                variant: "success",
                title: "Stock added",
                description: "The lot has been recorded successfully."
            });
            resetForm();
            onOpenChange(false);
            onCreated();
            ...
            show({
                ...
                description: (err === null || err === void 0 ? void 0 : err.message) || "Please try again."
            });
        } finally{
            setLoading(false);
        }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$sheet$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Sheet"], {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$sheet$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SheetContent"], {
            side: "right",
            className: "max-w-lg space-y-4 overflow-y-auto",
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$sheet$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SheetHeader"], {
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$sheet$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SheetTitle"], {
                            children: "Add stock lot"
                        }, void 0, false, {
                            fileName: "[project]/app/(dashboard)/dashboard/owner/inventory/page.tsx",
                            lineNumber: 592,
                            columnNumber: 11
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$sheet$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SheetDescription"], {
                            children: "Capture incoming inventory so the owner dashboard stays accurate."
                        }, void 0, false, {
                            fileName: "[project]/app/(dashboard)/dashboard/owner/inventory/page.tsx",
                            lineNumber: 593,
                            columnNumber: 11
                ...
                !tenantId ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: "No tenant context available."
                }, void 0, false, {
                    fileName: "[project]/app/(dashboard)/dashboard/owner/inventory/page.tsx",
                    lineNumber: 596,
                    columnNumber: 11
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                    ...
                                    children: [
                                        ...
                                        medicineOptions.map((medicine)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                value: medicine.id,
                                                children: [
                                                    medicine.name,
                                                    " ",
                                                    medicine.sku ? "(".concat(medicine.sku, ")") : ""
                                                ]
                                            }, medicine.id, true, {
                                                fileName: "[project]/app/(dashboard)/dashboard/owner/inventory/page.tsx",
                                                lineNumber: 609,
                                ...
                                medicinesLoading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$skeleton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Skeleton"], {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                        type: "submit",
                                        disabled: loading,
                                        children: loading ? "Saving..." : "Add stock"
                                    }, void 0, false, {
                                        fileName: "[project]/app/(dashboard)/dashboard/owner/inventory/page.tsx",
                                        lineNumber: 714,
                                        columnNumber: 17
...
_s1(AddStockSheet, "+498X8TT80DT/gVmouHC67ZZVoM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"]
    ];
});
_c1 = AddStockSheet;
function EditLotSheet(param) {
    let { item, tenantId, onClose, onUpdated, onDeleted } = param;
    _s2();
    const { show } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"])();
    const open = !!item;
    ...
    const [reorderLevel, setReorderLevel] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [expiryDate, setExpiryDate] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [sellPrice, setSellPrice] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [lotNumber, setLotNumber] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditLotSheet.useEffect": ()=>{
            ...
            var _item_quantity;
            setQuantity(String((_item_quantity = item.quantity) !== null && _item_quantity !== void 0 ? _item_quantity : ""));
            var _item_reorder_level;
            setReorderLevel(String((_item_reorder_level = item.reorder_level) !== null && _item_reorder_level !== void 0 ? _item_reorder_level : ""));
    ...
    const handleUpdate = async (event)=>{
        ...
        if (reorderLevel.trim() !== "") {
            ...
            if (Number.isNaN(parsed) || parsed < 0) {
                show({
                    ...
                    description: "Reorder level must be zero or higher."
                });
                return;
            }
        ...
        if (sellPrice.trim() !== "") {
            ...
            if (Number.isNaN(parsed) || parsed < 0) {
                show({
                    ...
                    description: "Sell price must be a positive number."
                });
                return;
            }
        ...
        setSaving(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InventoryAPI"].update(tenantId, item.id, payload);
            show({
                variant: "success",
                title: "Lot updated",
                description: "Inventory counts refreshed."
            });
            onUpdated();
            onClose();
        } catch (err) {
    ...
    const handleDelete = async ()=>{
        if (!item || !tenantId) return;
        const confirmed = window.confirm("Deleting this lot removes it from inventory history. Continue?");
        if (!confirmed) return;
        setDeleting(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InventoryAPI"].remove(tenantId, item.id);
            show({
                variant: "success",
                title: "Lot deleted",
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$sheet$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SheetHeader"], {
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$sheet$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SheetDescription"], {
                            children: "Update lot details or adjust counts. All changes are audit logged for owner visibility."
                        }, void 0, false, {
                            fileName: "[project]/app/(dashboard)/dashboard/owner/inventory/page.tsx",
                            lineNumber: 856,
                            columnNumber: 11
                ...
                !item ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "rounded border border-gray-200 bg-gray-50 p-3 text-xs text-gray-600",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s2(EditLotSheet, "f9MXVUWpDassEwtYMaSxceaSaqY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"]
    ];
});
...
__turbopack_context__.k.register(_c1, "AddStockSheet");
__turbopack_context__.k.register(_c2, "EditLotSheet");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_d852665d._.js.map