...
"[project]/app/(dashboard)/dashboard/staff/pos/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    const processSale = async ()=>{
        ...
        try {
            ...
            show({
                ...
                description: "Transaction processed successfully. Total: $".concat(getTotalAmount().toFixed(2))
            });
            setCart([]);
        } catch (err) {
            show({
                variant: "destructive",
                title: "Sale failed",
                description: (err === null || err === void 0 ? void 0 : err.message) || "Failed to process sale"
            });
        } finally{
            setProcessing(false);
        }
...
_s(StaffPOS, "hicR0Dx75uz++gJ9iwAgE/l7wQE=", false, function() {
    return [
...
_c = StaffPOS;
var _c;
__turbopack_context__.k.register(_c, "StaffPOS");
...
//# sourceMappingURL=app_%28dashboard%29_dashboard_staff_pos_page_tsx_580fb274._.js.map