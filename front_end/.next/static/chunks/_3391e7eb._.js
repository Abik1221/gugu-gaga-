...
function App(param) {
    ...
    React.useEffect({
        "App.useEffect": ()=>{
            async function fetchUser() {
                try {
                    const userData = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuthAPI"].me();
                    setUser({
 ...
 //   );
 // }
_s(App, "L6BF71gGphI4FELjDVv+UA/cA3E=", false, function() {
    return [
...
//# sourceMappingURL=_3391e7eb._.js.map